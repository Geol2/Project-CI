...
/**
 * This can be used to login an initialization function for the plugin with the given name.
 ...
 * place where you login event handlers on the server, add type definitions, load other
